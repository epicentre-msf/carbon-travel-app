...
mod_origin_input_server <- function(id, cities) {
  moduleServer(id, function(input, output, session) {
    ...
    observe({
      shinyWidgets::updateVirtualSelect("p1", choices = cities, selected = "france-paris")
      shinyWidgets::updateVirtualSelect("p2", choices = cities, selected = "united kingdom-london")
      # shinyWidgets::updateVirtualSelect("p3", choices = cities, selected = "spain-madrid")
      # shinyWidgets::updateVirtualSelect("p4", choices = cities, selected = "norway-oslo")
    })
